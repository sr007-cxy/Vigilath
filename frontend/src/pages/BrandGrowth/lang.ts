...
const ZH: Dict = {
  ...
  posTail: '末尾',
  posUnknown: '未知',
  hintTopMetrics: '本期 AI 答复里所有 citation URL 累计(SUM 答复里 citations 数组长度)。同 URL 出现多次也算多次',
...
const EN: Dict = {
  ...
  posTail: 'tail',
  posUnknown: 'unknown',
  hintTopMetrics: 'Cumulative citation URLs across all AI responses this period (SUM of citations[]). Same URL cited multiple times counts each time',
