          ...
          "dashboard": {
            ...
            "aiTelemetry": {
              ...
              "form": {
                ...
                "sceneFilterAll": "All",
                "reclassifyBtn": "Auto-classify existing",
                "reclassifyHint": "Heuristically re-tag historical queries into 4 scenes (search / qa / intent / brand). Idempotent.",
                "reclassifyRunning": "Classifying…",
                "reclassifyDone": "Classified {{n}}: search {{search}} / qa {{qa}} / intent {{intent}} / brand {{brand}}",
