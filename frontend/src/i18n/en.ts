const en = {
          "pageMeta": {
            ...
            "faq": {
              "title": "FAQ · Vigilath",
              "description": "Answers to common questions on GEO / AEO services, pricing, process, engine coverage, and how GEO differs from traditional SEO."
            },
            "login": {
          ...
          "home": {
            ...
            "faq": {
              "badge": "FAQ",
              "title": "Frequently Asked Questions",
              "subtitle": "The 20 questions buyers ask AI most, plus how Vigilath compares to traditional SEO tools.",
              "groups": [
                {
                ...
                },
                {
                  ...
                  "items": [
                    {
                      "q": "What's the real difference between Vigilath and traditional SEO tools?",
                      "a": "Traditional SEO tools revolve around ranking higher on the Google / Baidu results page — target keywords, build backlinks, wait to get crawled. Vigilath revolves around getting selected inside AI-generated answers, making ChatGPT, Perplexity, Gemini, DeepSeek, and Doubao mention you — with a citation — when they answer users' questions. The difference comes down to four things: goal (SERP ranking vs AI mention & citation), gateway (traditional search engines vs AI engines), metrics (keyword ranking / traffic vs AI mention rate / citation-slot share / visibility score), and data baseline (rankings swinging with the algorithm, no unified baseline, vs an independent third-party AI visibility baseline you can track quantitatively). The decision gateway is shifting from \"browsing links\" to \"asking AI\" — that's the layer Vigilath fills in."
                    },
                    {
                      "q": "When should I use Vigilath, and when traditional SEO tools?",
                      "a": "Use Vigilath when your customers start asking AI \"which is best\" or \"how do I choose\" before deciding, when you want to know how AI describes your brand, and when you need to win mention and citation slots inside AI answers. Traditional SEO tools still matter when your core traffic comes from clicks on the results page and you're building long-tail landing pages and backlinks. The two complement each other: Vigilath fills in the AI-search layer, and our GEO work avoids any aggressive tactics that would harm your existing SEO — many GEO signals are positive for SEO too."
                    },
                    {
                      "q": "Why not just use traditional SEO tools for AI optimization?",
                      "a": "Because the goal and the playbook differ. Traditional SEO tools optimize for crawlers and ranking algorithms and produce keyword rankings; AI engines synthesize multiple sources and cite as they generate, so they reward entity recognition, authority signals, and structured content — and you need a unified play across 10+ Western and CN engines. As an independent third-party AI visibility platform, Vigilath establishes your brand's AI visibility baseline and uses an 8-step automation pipeline to push your brand into the recommendation and citation slots of every major AI engine — an end-to-end AI search visibility solution (detect · audit · optimize · monitor), not something you can bolt onto a traditional SEO tool."
                    }
                  ]
                }
              ]
          ...
          "checkoutPending": {
            ...
            "methodStripeLabel": "Credit Card",
            "methodUsdc": "Pay with USDC on Base chain. Click \"Pay Now\" to generate a payment session, then complete it with MoltsPay CLI or any x402-compatible wallet.",
            "usdcWaiting": "Waiting for USDC payment...",
            "usdcAmount": "Amount",
            "usdcChain": "Chain",
            "usdcWallet": "Wallet",
            "usdcCopy": "Copy",
            "usdcStatus": "Status",
            "usdcPending": "Pending",
            "usdcHint": "Use MoltsPay CLI or any x402-compatible client to complete the payment.",
            "methodDomestic": "Click \"Pay Now\" to create your order. WeChat / Alipay payment is coming soon.",
            "methodWechatLabel": "WeChat Pay",
            "methodWechat": "Click \"Pay Now\" to generate a WeChat Pay QR code. Scan with WeChat to complete payment.",
            "wechatScanQr": "Scan the QR code below with WeChat",
            "wechatAmount": "Amount",
          ...
          "dashboard": {
            ...
            "aiTelemetry": {
              ...
              "overview": {
                ...
                "topDomainsTitle": "Top 10 cited domains",
                "topDomainsEmpty": "No citation data",
                "ownedTitle": "Owned vs Other",
                "ownedLegendOwned": "Owned",
                "ownedLegendOther": "Other",
                "ownedHint": "A domain is Owned when it contains a brand keyword",
                ...
                "selectTopic": "Topic",
                "noBrand": "Topic has no target keywords. AI visibility cannot be computed — edit the topic to set target + aliases.",
                ...
                "tipVisibility": "Successful responses with hit=true ÷ total successful responses this period. Keywords come from the topic's target + aliases — same source as the ✓ marks in the matrix.",
              ...
              "today": {
                ...
                "noRunToday": "No run today yet — click \"Run now\" to trigger one.",
                "runNow": "Run now",
                "runStatus": "Today's progress",
                "runStatusRunning": "{{done}}/{{total}} engines done, {{running}} running",
                "runStatusAllDone": "All {{total}} engines done · {{secs}}s",
                "runStatusFailed": "{{failed}} engine(s) failed",
                "runStartedAt": "Started {{time}}",
                "kpiQueries": "Queries today",
                "kpiQueriesUnit": "× {{engines}} engines = {{calls}} probes",
                "kpiMentionRate": "Brand mention rate",
                "kpiMentionRateUnit": "{{hits}} of {{total}} responses mention you",
                "kpiCitations": "AI citations",
                "kpiCitationsDeltaUp": "+{{n}} vs yesterday",
                "kpiCitationsDeltaDown": "{{n}} vs yesterday",
                "kpiCitationsDeltaSame": "same as yesterday",
                "kpiEngines": "Engines covered",
                ...
                "citedTitle": "Citations today",
                "citedHint": "Links cited in AI answers today, sorted by citation count",
                "citedEmpty": "AI hasn't cited any link today",
                "citedColRank": "#",
                "citedColTitle": "Page",
                "citedColDomain": "Domain",
                "citedColEngines": "Citing engines",
                "citedColCount": "Citations",
                "blindTitle": "Blind spots today",
                "blindHint": "Queries no AI mentioned your brand on today — these directions are weak",
                "blindEmpty": "Every query today got mentioned by at least one AI — well done",
                "tipMentionRate": "Share of successful responses today that mention the brand (target + aliases).",
                "tipCitations": "Total number of citation links across today's AI answers.",
                "tipEngines": "Engines with ≥ 1 successful response today / total engines configured."
              },
              "results": {
                "selectTopic": "Topic",
                "selectRun": "Run",
              ...
              "tracking": {
                ...
                "hitCells": "Hit cells",
                "timelineTitle": "First-mention timeline",
              ...
              "insight": {
                ...
                "analyzing": "Analyzing…",
                "refresh": "Re-analyze",
                "empty": "No diagnosis yet. Click Analyze to let the LLM interpret this cell.",
                "competitors": "Top competitors",
                "format": "Answer format",
                "citationDomains": "Frequent citation domains",
                "recommendations": "Recommendations",
                ...
                "verdict": {
                  "hit_stable": "Stable hit",
                  "hit_unstable": "Unstable hit",
                  "near_miss": "Near miss",
                  "no_signal": "No signal",
              ...
              "briefings": {
                "selectTopic": "Topic",
                "noTopics": "Create a topic first",
                "empty": "No briefings yet. Auto-generated Mon 09:00, or click Regenerate.",
                "regenerate": "Regenerate",
                "topActions": "Top actions next week",
                "generatedAt": "generated at",
                "rate": "Rate"
              },
              "form": {
                ...
                "step4": "GEO Strategy Plan",
                "step5": "Plan",
                "step6": "Content & Rollout",
                "step7": "Outcome Check",
                ...
                "step4Hint": "Project configured — view / generate the GEO Strategy Plan (diagnoses brand profile + AI engine responses).",
                "step4NoTopic": "Save the project in the first 3 steps, then come back here to view the GEO Strategy Plan.",
                "step4Idle": "No GEO Strategy Plan yet — click below to trigger one (uses brand profile + website).",
                "step4Generate": "Generate GEO Strategy Plan",
                "step4Generating": "Generating… takes 1-2 minutes",
                "step4Ready": "GEO Strategy Plan ready (updated {{at}})",
                ...
                "submitSeed": "📝 Submit",
                "submitSeedRunning": "Submitting…",
                "submitSeedHint": "Submit the current seed for platform review. Approved seeds become the topic's official seed (append-only).",
                "badgeApproved": "Locked",
                ...
                "targetHint": "When an AI engine mentions this term in its answer, that counts as a hit — this is the core signal GEO measures.",
                ...
                "seedGroupUngrouped": "Unassigned seed",
                ...
                "suggestIndustryPlaceholder": "Industry / vertical (optional, e.g. IDC / corporate law)",
                "suggestContextOn": "Bound to target \"{{target}}\" + aliases — candidates will avoid naming it (real SOV signal)",
                "suggestContextOff": "No target yet — candidates may name the seed directly (weak signal)",
                "suggestGenerateN": "Mine topics",
                "suggestRunningLong": "Mining… (30-90s)",
                "engines": "AI engines",
                "enginesCN": "CN",
            ...
            "compose": {
              "subtitle": "Draft per query / cluster, adapted to engine answer format + brand voice",
              "topicLabel": "Topic:",
              "noTopic": "No topic",
              "queriesTitle": "Queries",
              "queriesEmpty": "No queries in this topic",
              "clusterUngrouped": "Ungrouped",
              "selectQueryHint": "← Select a query to start drafting",
              ...
              "mockNotice": "* Static preview — LLM drafting not wired yet, content is placeholder",
              "statusTitle": "Status",
              ...
              "draftStub": {
                "fill": "(placeholder — will be replaced by real draft)",
                "list1": "Key point 1",
                "list2": "Key point 2",
                "list3": "Key point 3",
                ...
                "caseBg": "Case background",
                "caseProcess": "Resolution process",
                "caseOutcome": "Outcome & takeaways"
              }
            },
            "inbox": {
              "title": "Inbox",
            ...
            "posts": {
              "subtitle": "Pick channels for approved content and track delivery status",
              "newDispatch": "New dispatch",
              "empty": "No dispatch records",
              "mockNotice": "* Static preview — distribution APIs not wired yet, data is placeholder",
              ...
              "catOwned": "Owned",
              "catPr": "PR Wire",
              "catVertical": "Industry verticals",
              "catSocial": "Social",
              "ch": {
                "ownBlog": "Owned blog",
                "ownWechat": "WeChat OA",
                "ownNewsletter": "Newsletter",
                "prNewswire": "PR Newswire",
                "prBusinesswire": "Business Wire",
                "prChina": "PR China",
                "vertical36kr": "36Kr",
                "verticalTmt": "TMT Legal Observer",
                "verticalPinwan": "Pinwan",
                "verticalHuxiu": "Huxiu",
                "socialZhihu": "Zhihu",
                "socialWeibo": "Weibo",
                "socialXhs": "Xiaohongshu"
              },
              "dispatchTitle": "Pick distribution channels",
            ...
            "sentiment": {
              ...
              "articles": {
                "filters": {
                  ...
                  "time": "Time range",
                  "timeToday": "Today",
                  "timeH24": "Past 24 hours",
                  "time3d": "Past 3 days",
                  "time7d": "Past 1 week",
                  "time14d": "Past 2 weeks",
                  "time30d": "Past 1 month",
                  "time90d": "Past 3 months",
                  "timeAll": "All time",
                  "timeCustom": "Custom",
                  "timeStart": "Start",
                  "timeEnd": "End",
                ...
                "sort": {
                  ...
                  "trigger": "By {{label}}",
                  "default": "Default",
                  "scoreSubmenuLabel": "Score",
                  "scoreSubmenuTrigger": "Sort",
                  "disabledHint": "Data not collected for this signal",
                  "newest": "Newest",
                  "oldest": "Oldest",
                  "engagement": "Engagement",
                  "shares": "Shares",
                  ...
                  "views": "Views",
                  "cluster": "Cluster",
                  "mediaAZ": "Media name A-Z",
                  "mediaZA": "Media name Z-A",
                  "scoreSentiment": "Sentiment strength",
                  "scoreInfluence": "Influence",
                  "scoreGroupTitle": "Score-based",
                  "commentDetailCount": "Comment detail count",
                  "commentUpdatedAt": "Comment last-updated",
                  "relevance": "Relevance",
                  "favoritedFirst": "Favorites first",
                  "editor": "Editor sort",
          ...
          "admin": {
            ...
            "executionPlan": {
              ...
              "publishingPlanHint": "Ordered by AI coverage — lower coverage means the AI engines haven't picked up your brand for that question yet, so it needs the most content. The plan rolls forward one month at a time and auto-extends as it nears the end; you can also add, edit or remove rows anytime. Click a row to jump to content review.",
              "col": {
                "date": "Date",
            ...
            "contentReview": {
              ...
              "publishToMediumslyTitle": "Publish to Mediumsly",
              "publishToMediumslyHint": "Pushes the article body to mediumsly.com automatically. The author shown there will be this project's name; the live URL is written back when the push succeeds.",
              "publishToMediumslyConfirm": "Publish",
            ...
            "solution": {
              "title": "GEO Strategy Plan",
              "subtitle": "Generate a deliverable GEO Strategy Plan from site diagnostics + brand profile",
              "backToReview": "Back to review",
              "export": "Export PDF",
              "exportDocx": "Export Word",
              "exporting": "Exporting…",
              "regenerate": "Regenerate",
              "generate": "Generate GEO Strategy Plan",
              ...
              "retry": "Retry",
              "websiteLabel": "Brand website URL (optional)",
              "websitePlaceholder": "https://example.com",
              "websiteHint": "Optional — pre-filled from topic profile if set. Leave empty to skip the 25-category site diagnosis and only generate brand positioning / 7-step / keywords / vision.",
          ...
          "workbench": {
            ...
            "adminCrawl": {
              ...
              "colPages": "Pages",
              "colIps": "IPs",
              "colStatus": "Status codes",
              "colLastSeen": "Last seen",
              "topPages": "Top pages",
              "firstSeen": "First seen",
              "rowHint": "Click a crawler name to see its top pages.",
              "noBots": "No AI crawler activity in the current logs.",
              "notSeen": "Allowed in robots.txt but not seen yet",
              "notSeenCore": "Core",
              "notSeenOptional": "Optional"
            },
            "adminAccounts": {
              "title": "Customers",
            ...
            "adminAccountTopics": {
              ...
              "savedModal": {
                ...
                "colWebsite": "Website",
                "generateReport": "Generate GEO Strategy Plan",
                "viewReport": "View GEO Strategy Plan",
                "generating": "Starting…",
                "later": "Later",
