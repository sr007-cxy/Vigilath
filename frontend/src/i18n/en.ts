          ...
          "dashboard": {
            ...
            "aiTelemetry": {
              ...
              "form": {
                ...
                "queriesPickerTitle": "Queries (AI-generated, DeepSeek)",
                "queriesPickerHint": "Queries cannot be typed manually — pick from the AI-generated pool, up to {{max}}. Each \"Generate\" adds ~{{count}} candidates (you can run it multiple times).",
                "queriesPickerEmpty": "Pool is empty — enter a topic seed and click \"Generate\". DeepSeek will produce ~200 candidates for you to choose from.",
                ...
                "suggestContextOff": "No target yet — using generic prompt; candidates may name the seed directly (weak signal)",
                "suggestGenerateN": "Generate ~{{count}}",
                "suggestRunningLong": "Generating… (30-90s)",
                "engines": "AI engines",
                "enginesCN": "CN",
