          ...
          "dashboard": {
            ...
            "aiTelemetry": {
              ...
              "overview": {
                ...
                "topDomainsTitle": "引用平台 Top 10",
                "topDomainsEmpty": "暂无引用平台数据",
                "ownedTitle": "自家 vs 其他",
                "ownedLegendOwned": "自家",
                "ownedLegendOther": "其他",
                "ownedHint": "判定:domain 含品牌词 → 自家",
                ...
                "selectTopic": "选择话题",
                "noBrand": "话题未配置检测词,AI 可见度无法计算 — 请在话题编辑里填 target + 别名",
                "tooltipCitations": "引用",
                "tooltipDate": "日期",
                "intentTitle": "各意图簇的品牌提及率",
                "intentHint": "建话题时已按意图把问题自动聚成几簇。命中率低的簇 → 该方向内容是弱点,需补。",
                "intentResponseCount": "{{m}} / {{n}}",
                "intentUncategorized": "未分类",
                "tipVisibility": "本期命中(hit=true)的成功 response 数 ÷ 总成功 response 数。检测词取自话题的 target + 别名,跟矩阵 ✓ 同源。",
                ...
                "tipIntent": "建话题时已按意图把问题自动聚成几簇。簇下品牌提及率低 → 该方向内容是弱点,需补。",
              ...
              "form": {
                ...
                "queriesPickerHint": "Query 不能手填,只能从候选池里勾选,最多 {{max}} 条。每次「话题挖掘」会追加约 {{count}} 条候选(多轮可累积)。",
