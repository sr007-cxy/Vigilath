          ...
          "dashboard": {
            ...
            "aiTelemetry": {
              ...
              "form": {
                ...
                "queriesPickerTitle": "Query 选择(AI 生成,DeepSeek)",
                "queriesPickerHint": "Query 不能手填,只能从 AI 生成的候选池里勾选,最多 {{max}} 条。每次「AI 生成」会追加约 {{count}} 条候选(多轮生成可累积)。",
                "queriesPickerEmpty": "候选池为空 — 输入主题种子后点「AI 生成」,DeepSeek 会一次生成约 200 条候选供你筛选。",
                ...
                "suggestContextOff": "未填 target — 走通用 prompt,候选可能直接点名主题词(信号偏弱)",
                "suggestGenerateN": "AI 生成约 {{count}} 条",
                "suggestRunningLong": "生成中…(预计 30-90s)",
                "engines": "AI 引擎",
                "enginesCN": "国内",
                "enginesGlobal": "海外",
                "enabled": "启用",
