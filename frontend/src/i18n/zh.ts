const zh = {
          ...
          "dashboard": {
            ...
            "aiTelemetry": {
              "title": "AI 检测",
              "subtitle": "每天自动向各 AI 引擎提问你关心的话题,记录答案里有没有提到你品牌、引用了哪些网站",
              "tabOverview": "概览",
              "tabTracking": "提及追踪",
              "tabBriefings": "优化建议",
              "tabConfig": "话题配置",
              ...
              "overview": {
                ...
                "trendTitle": "被引用次数走势",
                "trendEmpty": "本周期还没有数据,等系统每天自动检测,或在话题列表点「立即检测一次」",
                ...
                "selectTopic": "选择话题",
                "noBrand": "话题没填品牌词,无法判断 AI 是否提到你 — 请回到「话题编辑」补上品牌词与别名",
                ...
                "tipVisibility": "本期 AI 答复中提到你品牌的比例 = 提到你的答复数 ÷ 总答复数。识别词来自话题里填的「品牌词 + 别名」。",
                "tipCitations": "本期所有 AI 答复里引用链接的总数,反映 AI 答案给你品牌带来的总曝光量。",
                "tipGrowth": "本期被引用次数 相对上一周期的变化百分比。绿色 = 上升,红色 = 下降。",
                "tipEngines": "本期至少有 1 条成功检测结果的 AI 引擎数 / 话题配置的 AI 引擎总数。",
                ...
                "tipIntent": "建话题时系统已把问题按方向自动归类。某方向提及率低 = 该方向内容是弱点,需要补。",
              ...
              "results": {
                "selectTopic": "选择话题",
                "selectRun": "选择检测批次",
                "noRuns": "该话题还没有检测记录,点话题列表的「立即检测一次」触发",
                "noTopics": "请先建一个话题",
                "runStatus": "状态",
                "runStarted": "开始",
                "runFinished": "结束",
              ...
              "form": {
                ...
                "submitSeedHint": "把当前种子词提交给平台审核,通过后固化为 topic 的官方种子(只增不改)",
                "badgeApproved": "已固化",
                "badgePending": "待审核",
                "badgeRejected": "已拒绝",
                "queryLockedHint": "该 Query 已审核固化,不可取消勾选",
                "prev": "上一步",
                "next": "下一步",
                "name": "话题名",
