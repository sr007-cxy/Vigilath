          ...
          "dashboard": {
            ...
            "aiTelemetry": {
              ...
              "form": {
                ...
                "sceneFilterAll": "全部",
                "reclassifyBtn": "一键分类已有问题",
                "reclassifyHint": "用启发式给历史 query 重新打 4 维场景标签(搜索 / 问答 / 意图 / 品牌),幂等可重跑",
                "reclassifyRunning": "分类中…",
                "reclassifyDone": "已分类 {{n}} 条:搜索 {{search}} / 问答 {{qa}} / 意图 {{intent}} / 品牌 {{brand}}",
                "clusterExpand": "展开",
                "clusterCollapse": "收起",
                "clusterPickAll": "全选此组",
