...
Logged-in users only: monthly quota comes from their Membership tier
(`monthly_check_quota`, where 0 means unlimited). Anonymous callers are
unlimited by design — see `docs/用户权益处理方案.md` §3.1.
"""
